...
public class adduserActivity extends BaseActivity {
  ...
  //  String path = "http://i3c8x94lqb.51http.tech/TXGLwai/updateStudentInfo?s_sid="+xuehao+"&s_city="+" "+"&s_company="+" "+"&s_job="+" "+"&image="+baseEncode;
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        handler.post(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(adduserActivity.this,"网络连接失败,",Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
